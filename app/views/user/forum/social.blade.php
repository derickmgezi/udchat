...
<div class="row">
    <div class="col-lg-12">
        <h2 class="page-header hidden-xs">
            <i class="fa fa-globe"></i> Social Life
    ...
    <div class="modal-dialog">
        <div class="modal-content custom-panel panel panel-default">
            ...
            <div class="modal-footer">
                <button type="button" class="btn btn-primary btn-lg">Submit Suggestion</button>
            </div>
        </div><!-- /.modal-content -->
    </div><!-- /.modal-dialog -->
</div><!-- /.modal -->
            ...
            <div class="modal-body panel-body">
                <ul class="chat">
                    <li class="left clearfix">
                        ...
                        <div class="chat-body clearfix">
                            ...
                            <small class="text-muted">
                                5 people liked this <button class="btn btn-primary btn-sm"><i class="fa fa-thumbs-o-up"></i> vote</button>
                            </small>
                        </div>
                    </li>
                    ...
                    <li class="left clearfix">
                        ...
                        <div class="chat-body clearfix">
                            <div class="header">
                                <strong class="primary-font">Masai</strong> 
                                <small class="pull-right text-muted">
                                    <span class="glyphicon glyphicon-time"></span> 12 mins ago
                                </small>
                            </div>
                    ...
                    <li class="right clearfix">
                        ...
                        <div class="chat-body clearfix">
                            <div class="header">
                                <small class=" text-muted">
                                    <span class="glyphicon glyphicon-time"></span> 13 mins ago</small>
                                <strong class="pull-right primary-font">Pancho</strong>
                            </div>
                            <p>
                                Lorem ipsum dolor sit amet, consectetur adipiscing elit. Curabitur bibendum ornare dolor, quis ullamcorper ligula sodales.
                            </p>
