<li class="timeline-inverted">
    ...
    <div class="timeline-panel">
        <div class="timeline-heading">
            <h4 class="timeline-title">Peter the Don</h4>
            <p>
...
<!--Point of Addition to Proposition Modal -->
<div class="modal fade" id="POAproposeModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content panel custom-panel panel-default">
                ...
                <ul class="chat">
                    ...
                    <div class="input-group">
                        ...
                        <span class="input-group-btn">
                            <button class="btn btn-info btn-lg" id="btn-chat">
                                <span class="glyphicon glyphicon-hand-up"></span>
                            </button>
                        </span>
                    </div>
