    ...
    <div class="panel panel-default">
        <div class="panel-heading">
            <ul class="chat">
                ...
                <button type="button" class="btn btn-warning pull-right" data-toggle="modal" data-target="#editHeadingModal">
        ...
        <div class="panel-body">
            ...
            <button type="button" class="btn btn-warning pull-right my-move-change-button" data-toggle="modal" data-target="#changeImageModal">
                <span class="fa fa-edit"></span> change
            </button>
            <br>
        ...
        <div class="panel-footer">
            <center>
                <button type="button" class="btn btn-danger" id="delete" data-container="body" data-html="true" data-toggle="popover" title="Are you sure?" data-content="<button class='btn btn-danger'>yes</button>&nbsp;<button class='btn btn-default' id='cancel'>cancel</button>"><span class="glyphicon glyphicon-trash"></span> Delete this Advert</button>
            </center>
        </div>
    </div>
    <hr>
...
<!--Edit Heading Modal -->
<div class="modal fade" id="editHeadingModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    <div class="modal-dialog">
